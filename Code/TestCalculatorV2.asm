...
PRINTRESULTS
	...
	; --- PRINT MINIMUM ---
	LEA R0, LBLMIN                     ;PRINT "Minimum: "
	PUTS
	LD R1, MIN                         ;LOAD MIN INTO R1
...
MAXTENSDONE
	...
	; --- PRINT AVERAGE ---
	LEA R0, LBLAVG                     ;PRINT "Average: "
	PUTS
	LD R1, AVG                         ;LOAD AVG INTO R1
	AND R2, R2, #0                     ;CLEAR R2 (WILL HOLD TENS DIGIT)
	AND R3, R3, #0                     ;CLEAR R3
	ADD R3, R3, #-9                    ;BUILD -10 FOR DIVISION
	ADD R3, R3, #-1                    ;R3 = -10
...
AVGTENSDONE
	...
	; --- PRINT GRADE ---
	LEA R0, LBLGRD                     ;PRINT "Grade: "
	PUTS
	LD R0, GRADE                       ;LOAD GRADE (ALREADY ASCII)
